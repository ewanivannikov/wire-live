...
- [ ] 5.5 Обучить рисованию стрелочек итому, как распространяется сигнал через уровень (Инструктаж) или череду уровней
- [ ] 5.5.1 Починить Инструктаж
...
- [x] 7. ⤊ Создать editor
- [ ] 8. 🐞 Когда выбрана не кисть, скрывать контекст Знаков
- [ ] 9. 🐞 Список уровней воспринимается как уровень(пример: если выйти с уровня в момент чекинга)
- [ ] 10. Каким-то образом отделать вводы и выводы друг от друга(буквой, цифрой, чем-то) - это бейджи.
