...
- [ ] 11.1 "Добрый аутпут"(если в зациклинной последовательности он находит нужный паттерн, он валидирует уровень)
- [ ] 11.2 Сделать разрыватель цикла(при долгом количестве циклов останавливать уровень и переводить игрока на solving)
