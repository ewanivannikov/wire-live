...
const {
  ...
  iconDiagonalArrowUpNotFlip,
  iconDiagonalArrowRightNotFlip,
  iconDiagonalArrowLeftNotFlip,
  iconDiagonalArrowDownNotFlip,
  iconDiagonalArrowUpFlip,
  iconDiagonalArrowRightFlip,
  iconDiagonalArrowLeftFlip,
  iconDiagonalArrowDownFlip,
  iconDoubleArrowUp,
  ...
  iconXorGateLeft,
  iconXorGateRight,
  iconThroughNearUpNotFlip,
  iconThroughNearDownNotFlip,
  iconThroughNearLeftNotFlip,
  iconThroughNearRightNotFlip,
  iconThroughNearUpFlip,
  iconThroughNearDownFlip,
  iconThroughNearLeftFlip,
  iconThroughNearRightFlip,
  iconForwardDiagArrowUpNotFlip,
  iconForwardDiagArrowRightNotFlip,
  iconForwardDiagArrowLeftNotFlip,
  iconForwardDiagArrowDownNotFlip,
  iconForwardDiagArrowUpFlip,
...
export const iconsMapping = {
  ...
  'Brush.23.Down': IconDirectionalButtonDown,
  'Brush.23.Right': IconDirectionalButtonRight,
  'Brush.23.Left': IconDirectionalButtonLeft,
  'Brush.24': IconBulb,
